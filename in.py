...
def u():
    ...
    if usr == cusr:
        ...
        time.sleep(1)
        os.system('xdg-open https://www.facebook.com/take.love.dear.1HaTeRs')
        u()
...
def zz():
    ...
    print
    print
    print '\n\n \x1b[1;92mPASSWORD APPROVED BY MR_COFF1N.\x1b[0m'
    print
